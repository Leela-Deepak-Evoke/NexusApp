...
class OrgUpdateHeaderCardView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OrgUpdateHeaderCardView> createState() => _OrgUpdateHeaderCardViewState();
}

class _OrgUpdateHeaderCardViewState extends ConsumerState<OrgUpdateHeaderCardView> {
  @override
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title:
                            Text(widget.item.author!, style: const TextStyle(fontSize: 16)),
                        subtitle: Text(
