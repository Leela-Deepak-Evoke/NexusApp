...
import 'package:evoke_nexus_app/app/screens/review/widgets/review_mobile_view.dart';
...
class ReviewScreenSmall extends ConsumerStatefulWidget {
   bool? isFromHomePage;

   ReviewScreenSmall({super.key, this.isFromHomePage});
  @override
  ConsumerState<ReviewScreenSmall> createState() => _ReviewScreenSmallState();
}

class _ReviewScreenSmallState extends ConsumerState<ReviewScreenSmall> {
